...
venue: "UniTo ESOMAS Master in Economics: Python"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Corso Unione Sovietica 218 bis, Torino"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Sep 30, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "16:00-18:00"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-09-30      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-11-25        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Florian Oswald"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["florian.oswald@unito.it"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://codimd.web.cern.ch/v9Rkv8z5QL2tzOxFaUks2A
...
This is the python section of our course. Please read carefully through this entire page.
...
<p>
<strong>Content: </strong>Much of the content in this part of our course is based on <strong><a href="https://carpentries.org">The Carpentries</a></strong> project.
{% if site.carpentry == "swc" %}
...
Notice that sessions are much shorter than 2 hours at a time, so we will be relatively fast going through this material.
